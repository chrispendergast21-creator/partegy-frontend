      ...
      <main className="max-w-7xl mx-auto px-8 py-8 space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-1">Connect Partegy to your existing systems</p>
          </div>
          <div className="bg-slate-900 border border-slate-700 rounded-xl px-6 py-3 text-center">
