        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-12">
              <div>
                <h1 className="text-2xl font-semibold text-white">Executive Partnership Cockpit</h1>
                <p className="text-slate-300 text-sm mt-1">{currentOrg.name} • Strategic Partnership Capital Allocation</p>
              </div>
              <PageNavigation />
            </div>
